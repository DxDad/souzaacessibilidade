(() => {
  ...
  function gtag_report_conversion() {
   window.gtag('event', 'conversion', {
    'send_to': 'AW-18476493707/KIshCO6My4YdEIvXo-pE',
    'value': 1.0,
    'currency': 'BRL'
   });
  }
  ...
  if (!document.querySelector('.whatsapp-float')) {
    ...
    whatsappLink.dataset.googleAdsConversion = 'true';
  ...
  element.addEventListener('click', () => {
    window.gtag('event', element.dataset.trackEvent);

    if (element.dataset.googleAdsConversion === 'true') {
